    ...
    <div className="footer">
      <div className="top-container">
        <div>
          <ul>
            <li>
              <span className="link-header">Company</span>
            </li>
            <li>
        ...
        <div>
          <ul>
            <li>
              <span className="link-header">Legal</span>
            </li>
            <li>
        ...
        <div>
          <ul>
            <li>
              <span className="link-header">Install App</span>
            </li>
            <li>
              <Link to={"/"}>
                <img
      ...
      <div className="bottom-container">
        <div>
          <p>&copy; 2021 LILIES, All rights reserved</p>
        </div>
