  ...
  return (
    ...
    <div className='home'>
      ...
      <div className='nav'>
        ...
        <div>
          <ul>
            <li><Link to="/" style={{color: '#FBDDBB'}}>Home</Link></li>
            <li><Link to="/login" style={{color: '#FFFFFF'}}>Login</Link></li>
            <li><Link to="/signup" className='unique'>Sign Up</Link></li>
          </ul>
        </div>
        ...
        <div className='section3'>
          <Food imageName={Image2} altTitle={'image2'} foodName={'Stir fry Pasta'} />
        ...
        <div className='section4'>
          ...
          <div>
            <form>
              <input type={'email'} name="email" placeholder='gregphillips@gmail.com'/>
